...
| Artisan code generation | `cargo` + proc-macros + `clap` | `cargo rustavel make:*` with `xtask` |
...
| **M5** DX, CLI & Testing | `cargo rustavel` CLI, `make:*` generators, `TestCase` harness | M0–M4 |
